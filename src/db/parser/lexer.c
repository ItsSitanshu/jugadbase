...
char* keywords[NO_OF_KEYWORDS] = {
  ...
  "BOOL", "FLOAT", "DOUBLE", "DECIMAL", "DATE", "TIME", "TIMETZ",
  "DATETIME", "DATETIMETZ", "TIMESTAMP", "TIMESTAMPTZ", "INTERVAL", "BLOB", "JSON",
  "UUID", "SERIAL", "true", "false", "UINT", "LIKE", "BETWEEN", "ASC", "DESC", "IF", "EXISTS",
  "CASCADE", "RESTRICT", "RETURNING"
};
...
uint8_t KWCHAR_TYPE_MAP[NO_OF_KEYWORDS] = {
  ...
  TOK_T_BOOL, TOK_T_FLOAT, TOK_T_DOUBLE, TOK_T_DECIMAL, TOK_T_DATE, TOK_T_TIME,
  TOK_T_TIME_TZ,  TOK_T_DATETIME, TOK_T_DATETIME_TZ, TOK_T_TIMESTAMP, TOK_T_TIMESTAMP_TZ,
  TOK_T_INTERVAL, TOK_T_BLOB, TOK_T_JSON, TOK_T_UUID, TOK_T_SERIAL, TOK_L_BOOL,
  TOK_L_BOOL, TOK_T_UINT, TOK_LIKE, TOK_BETWEEN, TOK_ASC, TOK_DESC, TOK_IF, TOK_EXISTS,
  TOK_CASCADE, TOK_RESTRICT, TOK_RETURNING
};
