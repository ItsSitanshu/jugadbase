...
char* keywords[NO_OF_KEYWORDS] = {
  ...
  "BOOL", "FLOAT", "DOUBLE", "DECIMAL", "DATE", "DATETZ", "TIME",
  "DATETIME", "DATETIMETZ", "TIMESTAMP", "TIMESTAMPTZ", "INTERVAL", "BLOB", "JSON",
  "UUID", "SERIAL", "true", "false", "UINT", "LIKE", "BETWEEN", "ASC", "DESC"
};
...
Token* lexer_handle_alpha(Lexer* lexer) {
  ...
  */
  ...
  uint8_t KWCHAR_TYPE_MAP[NO_OF_KEYWORDS] = {
    ...
    TOK_L_BOOL, TOK_T_UINT, TOK_LIKE, TOK_BETWEEN, TOK_ASC, TOK_DESC
  };
